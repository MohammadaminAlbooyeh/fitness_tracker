...
class PaymentEventPublisherIntegrationTest {
    ...
    @Test
    void publishPaymentCompleted_sendsEventToKafka() throws Exception {
        ...
        template.setDefaultTopic("payment.completed");
        ...
        ContainerProperties containerProps = new ContainerProperties("payment.completed");
        ...
        assertEquals(1L, event.get("paymentId"));
        assertEquals(10L, event.get("orderId"));
